...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Cannon500mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Cannon500mm", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "500mm.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                ...
                Scope = "None", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "500mm Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Color = Color(red: 25f, green: 0, blue: 25f, alpha: 1), // Deprecated, set color in particle sbc.
            ...
            Ammos = new[] {
                SemiArmorPiercing500mm, HighExplosiveFrag, 
