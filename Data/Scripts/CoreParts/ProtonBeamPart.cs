...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ProtonBeam => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ProtonBeam", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = " GB84 Proton Beam", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
