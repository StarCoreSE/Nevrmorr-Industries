...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef NI_MissileLaunch => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "NI_Launch", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "NI_Accel", // AmmoRound field of the ammo to spawn.
        ...
        private AmmoDef NI_MissileAcceleration => new AmmoDef // Your ID, for slotting into the Weapon CS --- This ammo has been stripped to a minimal config as an example
        {
            AmmoMagazine = "Energy",
            AmmoRound = "NI_Accel",
            HybridRound = false,
