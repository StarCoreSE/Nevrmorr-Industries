...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Cannon1500mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Cannon1500mm", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "1500mm Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SemiArmorPiercing1500mm, HighExplosiveFrag,  
