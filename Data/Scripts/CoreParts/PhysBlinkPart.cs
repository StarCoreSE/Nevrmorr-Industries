...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition PhysBlink => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "PhysBlink", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "PhysBlink", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
