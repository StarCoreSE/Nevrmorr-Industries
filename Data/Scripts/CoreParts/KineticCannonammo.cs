...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef ZeroGTorp => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "0G Torpedo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 9,
                    CustomParticle = "ExplosionEffect", // Particle SubtypeID, from your Particle SBC
            ...
            {
                ModelName = "\\Models\\Ammo\\TorpModel.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
