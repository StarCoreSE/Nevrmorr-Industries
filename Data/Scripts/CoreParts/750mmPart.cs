...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Cannon750mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Cannon750mm", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "750mm.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
            ...
            {
                PartName = "750mm Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
