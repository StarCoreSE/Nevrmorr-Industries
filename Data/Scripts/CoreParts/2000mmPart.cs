...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Cannon2000mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Cannon2000mm", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "2000mm Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SemiArmorPiercing2000mm, HighExplosiveFrag,
