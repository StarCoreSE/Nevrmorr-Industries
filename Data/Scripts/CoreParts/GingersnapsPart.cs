...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Gingersnaps => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Gingersnaps", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "105mm.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                ...
                Muzzles = new[] {
                    ...
                    "muzzle_02",
                    "muzzle_03",
                    "muzzle_04", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
            ...
            Targeting = new TargetingDef
            {
                ...
                MaximumDiameter = 3000, // Maximum radius of threat to engage; 0 = unlimited.
            ...
            {
                PartName = "Gingersnaps", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Energy_Explosion", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                NI_MissileLaunch, NI_MissileAcceleration,
