...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Cannon250mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Cannon250mm", // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "250mm.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
            ...
            {
                PartName = "250mm Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SemiArmorPiercing250mm, HighExplosiveFrag, 
